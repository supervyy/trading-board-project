...
def main():
    ...
    # 1. Credentials - ITERATION 1 (uses separate keys)
    keys = {}
    if KEYS_PATH.exists():
    ...
    # Use Iteration1 keys for this deployment
    API_KEY = keys.get("APCA-API-KEY-ID-Iteration1") or os.getenv("ALPACA_API_KEY_ITERATION1")
    SECRET_KEY = keys.get("APCA-API-SECRET-KEY-Iteration1") or os.getenv("ALPACA_SECRET_KEY_ITERATION1")
    
    print("📋 Using Iteration 1 API Keys (separate account)")
